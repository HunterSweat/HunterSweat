...
/**
 * Class ArileWP_Customize_Dimensions_Control
 */
class ArileWP_Customize_Dimensions_Control extends ArileWP_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'arilewp-dimensions';

	/**
	 * ArileWP_Customize_Dimensions_Control constructor.
	 *
	...
	public function localize_script() {
		...
		wp_localize_script( 'arilewp-controls', 'dimensionsarilewpL10n', $this->l10n() );
	...
	protected function l10n() {
		return array(
			'top'    => esc_attr__( 'Top', 'arilewp' ),
			'right'  => esc_attr__( 'Right', 'arilewp' ),
			'bottom' => esc_attr__( 'Bottom', 'arilewp' ),
			'left'   => esc_attr__( 'Left', 'arilewp' ),
		);
	}
